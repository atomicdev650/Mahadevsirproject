    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <div class="carousel-caption car">
          <h3 style="color:#b29600">"We are Specialized In Managing Employies"</h3>
      ...
      <div class="item">
        ...
        <div class="carousel-caption car black carL">
          <h3 style="color:#b29600" >Project Made with Love . </h3>
...
<div id="band" class="container text-center">
  ...
  <p>Thats why we keep a track of our employies they should not get less leaves they should be productive at work place </p>
  </div>
  <div class="hr">
 <hr >
  </div>
  ...
  <div id="# " class="row humpty">
    <div class="col-sm-4">
      <p class="text-center"><strong> Abhinay Pawar</strong></p><br>
   ...
   <div class="col-sm-4">
      <p class="text-center"><strong> Ravi Badan </strong></p><br>
     ...
     <div class="col-sm-4">
      <p class="text-center"><strong> Devesh </strong></p><br>
  ...
  <div class="row humpty">
    <div class="col-sm-4">
      <p class="text-center"><strong> Ankit Yadav</strong></p><br>
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4 ">
      <p><span class="glyphicon glyphicon-map-marker"></span>&nbspIndia , Goa</p>
      <p><span class="glyphicon glyphicon-phone"></span>&nbspPhone: +91 7821882192</p>
      <p><span class="glyphicon glyphicon-envelope"></span>&nbsp Email : abhinaypawar470@gmail.com</p>    
    </div>
    <div class="col-md-8">
      <div class="row ">
